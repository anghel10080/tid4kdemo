...
$valori = cadran_simulatValoriVariabile();
$surse_php = $valori['surse_php'];
...
$formatareDataOra = $dataOra->format('d.m.Y, H:i');
    ...
    $cadran_simulatTitlu1Rand2 = 'Meniul Saptamanii';
    $cadran_simulatTitlu1Rand3 = 'Grupa Mica';
    $cadran_simulatTitlu2Rand3 = 'Clasa I';
    $cadran_simulatTitlu1Rand3 = 'Administrative';
...
var ultimaInregistrare = " . json_encode($ultimaInregistrare) . ";
</script>";
...
var titluriCadran = {
  ...
  cadran_simulatTitlu1Rand3: 'Grupa Mica',
  cadran_simulatTitlu2Rand3: 'Clasa I',
  cadran_simulatTitlu3Rand3: 'Administrative'
};
...
var surse_php = {
        ...
        'grupa mica' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=grupa_mica',
        'grupa mijlocie' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=grupa_mijlocie',
        'grupa mare' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=grupa_mare',
        'clasa pregatitoare' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_pregatitoare',
        'clasa I' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_I',
        'clasa II' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_II',
        'clasa III' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_III',
        'clasa IV' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_IV',
        'clasa V' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_V',
        'clasa VI' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_VI',
        'clasa VII' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_VII',
        'clasa VIII' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_VIII',
        'clasa IX' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_IX',
        'clasa X' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_X',
        'clasa XI' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_XI',
        'clasa XII' : '/pages/documentele_noastre/fetch_files.php?source=infodisplay&optiuneSelectata=clasa_XII',
        // Continuă cu restul cheilor și valorilor
    };
window.onload = function() {
  ...
  incarcaContinutInChenar('chenar1Rand2', titluriCadran.cadran_simulatTitlu1Rand2);
  incarcaContinutInChenar('chenar1Rand3', titluriCadran.cadran_simulatTitlu1Rand3);
  incarcaContinutInChenar('chenar2Rand3', titluriCadran.cadran_simulatTitlu2Rand3);
  incarcaContinutInChenar('chenar3Rand3', titluriCadran.cadran_simulatTitlu3Rand3);
...
function incarcaContinutInChenar(idChenar, titluriCadran) {
    let chenar = document.getElementById(idChenar);
    if (!chenar) {
        console.error('Chenarul cu ID-ul', idChenar, 'nu a fost găsit.');
        return;
    }

    let urlSursa = surse_php[titluriCadran];
    if (!urlSursa) {
        console.error('URL sursă pentru', titluriCadran, 'nu a fost găsit în surse_php.');
        return;
    }
