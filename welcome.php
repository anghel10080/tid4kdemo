...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<h1 style='font-size: 60px; font-weight: bold; font-family: Lora, serif;'>Bun venit, " . $nume_prenume . "!</h1>";
    if ($status_utilizator == 'parinte') {
        echo "<p style='font-size: 24px; font-family: Poppins, sans-serif;'>Vei fi redirecționat în câteva secunde către grupa/clasa copilului tău, " . $nume_copil . ".</p>";
    } else {
        echo "<p style='font-size: 24px; font-family: Poppins, sans-serif;'>Vei fi redirecționat în câteva secunde către grupa/clasa " . $grupa_clasa_copil . ".</p>";
    }
    echo "<p style='font-size: 20px; font-family: Poppins, sans-serif;'>Dacă nu ești redirecționat automat, te rugăm să accesezi <a href='/pages/grupa_clasa_copil.php'>pagina corespunzătoare</a></p>";
