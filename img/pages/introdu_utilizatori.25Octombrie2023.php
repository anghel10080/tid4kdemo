...
function listeazaUtilizatori() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            tableHTML += "<h2>Profesori</h2><table><thead><tr><th>Nr. crt.</th><th>Nume</th><th>Email</th><th>Telefon</th><th>ID</th></tr></thead><tbody>";
            for (var i = 0; i < data.profesori.length; i++) {
                tableHTML += "<tr><td>" + (i + 1) + "</td><td>" + data.profesori[i].nume_prenume + "</td><td>" + data.profesori[i].email + "</td><td>" + data.profesori[i].telefon + "</td><td>" + data.profesori[i].id_utilizator + "</td></tr>";
            }
            tableHTML += "</tbody></table>";

            // Crearea tabelei pentru părinți
            tableHTML += "<h2>Părinți</h2><table><thead><tr><th>Nr. crt.</th><th>Nume</th><th>Email</th><th>Telefon</th><th>Nume Copil</th><th>Vârsta</th><th>Grupă/Clasă</th><th>ID</th></tr></thead><tbody>";
            for (var i = 0; i < data.parinti.length; i++) {
                tableHTML += "<tr><td>" + (i + 1) + "</td><td>" + data.parinti[i].nume_prenume + "</td><td>" + data.parinti[i].email + "</td><td>" + data.parinti[i].telefon + "</td><td>" + data.parinti[i].nume_copil + "</td><td>" + data.parinti[i].varsta_copil + "</td><td>" + data.parinti[i].grupa_clasa_copil + "</td><td>" + data.parinti[i].id_utilizator + "</td></tr>";
            }
            tableHTML += "</tbody></table>";
    ...
    xhttp.open("GET", "introdu_utilizatori.php?list_users=true", true);
    xhttp.send();
}
 ...
 <button type="button" onclick="verificaTelefon()" style="background-color: green; color: white;">Verifică</button>
  ...
  <div style="display: flex; align-items: center;">
    ...
    <select id="grupa_clasa_copil" name="grupa_clasa_copil" style="margin-right: 10px;">
      <option value="grupa mica" selected>Grupa Mică</option>
