...
<body>
    <div class="formular">
        <div class="parinti-info">
            <p>Acesta este un proiect de comunicare digitală , securizată, prin care puteți accesa în detaliu informațiile legate de copilul dumneavoastră și activitățile unității școlare Grădinița 248.</p>
        </div>
...
<div class="input-group">
    ...
    <input type="hidden" type="text" id="nume_copil" name="nume_copil">
</div>
<div class="input-group">
    <!--<label for="varsta_copil">Vârsta copilului:</label>-->
    <input type="hidden" type="number" id="varsta_copil" name="varsta_copil" min="1" max="20">
</div>
<div class="input-group">
