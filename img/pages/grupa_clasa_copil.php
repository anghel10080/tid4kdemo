...
?>
       ...
       <li class="doc-item"><a href="/pages/tabel_meniu_afisat.php">Meniul</a> <a href="/pages/documentele_noastre/documente_meniuri.php">si administrative</a></li>
...
afiseazaCarduriClicProfesori(fereastraGrid);
            ...
            let numarCarduriPeRand = 4; // Numărul de carduri pe rând
